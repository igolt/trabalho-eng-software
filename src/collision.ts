...
export const collide = (
  ...
  switch (value) {
    ...
    case 2:
      ...
      break;
    case 3:
      if (collidePlatformTop(object, tileY)) return;
      collidePlatformRight(object, tileX + tileSize);
      break;
    case 4:
    ...
    case 5:
      ...
      break;
    case 6:
      if (collidePlatformRight(object, tileX + tileSize)) return;
      collidePlatformBottom(object, tileY + tileSize);
      break;
    case 7:
      if (collidePlatformTop(object, tileY)) return;
      if (collidePlatformBottom(object, tileY + tileSize)) return;
      collidePlatformRight(object, tileX + tileSize);
      break;
    case 8:
    ...
    case 9:
      ...
      break;
    case 10:
      if (collidePlatformLeft(object, tileX)) return;
      collidePlatformRight(object, tileX + tileSize);
      break;
    case 11:
      if (collidePlatformTop(object, tileY)) return;
